...
def main():
    ...
    # if PowerSweep:
    #     mass_idx = 8
    #     freq_bins = [(10, 19), (20, 29)]
    #     k_vals, c_vals, results = sweep_power_vs_k_c(m, k_inter, c_inter, f_vals, F_ext,
    #                                                  mass_idx, freq_bins)
    ...
    #     import pandas as pd
    #     summary_rows = []
    #     for mode_idx in range(len(freq_bins)):
    #         for j, c_scale in enumerate(c_vals):
    #             for i, k_scale in enumerate(k_vals):
    #                 index = j * len(k_vals) + i
    #                 summary_rows.append({
    #                     "Mode": mode_idx + 1,
    #                     "Freq Bin": f"{freq_bins[mode_idx][0]}–{freq_bins[mode_idx][1]} Hz",
    #                     "c Scale": c_scale,
    #                     "k Scale": k_scale,
    #                     "Peak Power [VAR]": results[mode_idx][index]
    #                 })
    ...
    if PowerSweep:
        ...
        k_vals, c_vals, results = sweep_power_vs_k_c(
            ...
            c_factors=np.linspace(0.5, 1.5, 3),
